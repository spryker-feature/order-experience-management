...
class ScheduleReviewItemUpdatePlanMerger implements ScheduleReviewItemUpdatePlanMergerInterface
{
    /**
    ...
    {
        foreach ($additionalRecurringScheduleItemTransfers as $idRecurringScheduleItem => $additionalRecurringScheduleItemTransfer) {
            $recurringScheduleItemTransfer = $recurringScheduleItemTransfers[$idRecurringScheduleItem] ?? null;

            if ($recurringScheduleItemTransfer === null) {
                $recurringScheduleItemTransfers[$idRecurringScheduleItem] = $additionalRecurringScheduleItemTransfer;

                continue;
            }

            $recurringScheduleItemTransfer->fromArray($additionalRecurringScheduleItemTransfer->modifiedToArray());
        }
