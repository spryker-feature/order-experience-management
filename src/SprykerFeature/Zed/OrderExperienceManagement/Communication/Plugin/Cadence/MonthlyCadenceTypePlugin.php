...
class MonthlyCadenceTypePlugin extends AbstractPlugin implements CadenceTypePluginInterface
{
    protected const string DISPLAY_KEY = 'recurring_orders.cadence.monthly';
    ...
    {
        return OrderExperienceManagementConfig::CADENCE_TYPE_MONTHLY;
    }
    ...
    {
        return $currentTriggerDate->modify('+1 month');
    }
