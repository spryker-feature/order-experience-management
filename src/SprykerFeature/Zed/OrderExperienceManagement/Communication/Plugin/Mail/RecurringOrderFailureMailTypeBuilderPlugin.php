 ...
 */
class RecurringOrderFailureMailTypeBuilderPlugin extends AbstractPlugin implements MailTypeBuilderPluginInterface
{
    public const string MAIL_TYPE = 'recurring_orders.notify_buyer_placement_failure';

    protected const string MAIL_TEMPLATE_HTML = 'OrderExperienceManagement/Mail/notify-buyer-placement-failure.html.twig';

    protected const string MAIL_TEMPLATE_TEXT = 'OrderExperienceManagement/Mail/notify-buyer-placement-failure.text.twig';
     ...
     * - Builds the `MailTransfer` with data for `subscription.notify_buyer_placement_failure` mail.
     *
     * @api
     */
