...
class IsOrderPlacedConditionTest extends Unit
{
    ...
    public function testCheckReturnsTrueWhenCheckerReturnsTrue(): void
    {
        ...
        $checkerMock->method('isOrderPlaced')->willReturn(true);
    ...
    {
        $checkerMock = $this->createMock(RecurringScheduleDueCheckerInterface::class);
        $checkerMock->method('isOrderPlaced')->willReturn(false);
    ...
    protected function createCondition(RecurringScheduleDueCheckerInterface $recurringScheduleDueChecker): IsOrderPlacedConditionPlugin
    {
        ...
        return new class ($businessFactoryMock) extends IsOrderPlacedConditionPlugin {
